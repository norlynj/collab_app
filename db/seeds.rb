...
# Create labels
Label.create(tag: "FE", description: "Front End Tasks")
Label.create(tag: "BE", description: "Back End Tasks")
Label.create(tag: "TE", description: "Test Functionality")

# Create users
user1 = User.create(name: "John Doe", email: "john@example.com", password: "password", role: "group_leader")
user2 = User.create(name: "Jane Smith", email: "jane@example.com", password: "password", role: "member")
user3 = User.create(name: "Juan Dela Cruz", email: "juan@example.com", password: "password", role: "member")
user4 = User.create(name: "Juana Dela Cruz", email: "juana@example.com", password: "password", role: "member")


# Create tasks
task1 = Task.create(title: "Create UI for home page", status: "Pending", description: "Description 1", label_id: 1, user_id: user2.id)
task2 = Task.create(title: "Implement authentication mechanism", status: "Completed", description: "Description 2", label_id: 2, user_id: user3.id)
task3 = Task.create(title: "Test UI functionalities", status: "Pending", description: "Description 3", label_id: 3, user_id: user4.id)
